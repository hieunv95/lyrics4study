			...
			<div class="top-navigation">
				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar">
					...
					<li><a href="#" class="song-icon"><span class="glyphicon glyphicon-music" aria-hidden="true"></span>Top Songs</a></li>
					<li><a href="#" class="song-icon"><span class="glyphicon glyphicon-music" aria-hidden="true"></span>New Songs</a></li>
				  </ul>
				  <!-- script-for-menu -->
						<script>
				...
				<div class="top-grids">
					...
					<div class="col-md-4 resent-grid recommended-grid slider-top-grids">
						<div class="resent-grid-img recommended-grid-img">
							<a href="{{ url('/lyric') }}"><img src="images/t1.jpg" alt="" /></a>
							<div class="time">
								<p>3:04</p>
							</div>
							<div class="clck">
						...
						<div class="resent-grid-info recommended-grid-info">
							<h3><a href="{{ url('/lyric') }}" class="title title-info">My Love</a></h3>
							<ul>
								<li><p class="author author-info"><a href="#" class="author">Westlife</a></p></li>
